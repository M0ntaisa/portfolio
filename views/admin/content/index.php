                               ...
                               <div class="row">
                                               ...
                                               <div class="card">
                                                   ...
                                                   <div class="card-footer bg-c-red">
                                                       <div class="row align-items-center">
                                                           ...
                                                           <div class="col-3 text-right">
                                                               <i
                                                                   class="feather icon-trending-down text-white f-16"></i>
                                                           </div>
                                                       </div>
                                                   </div>
                                               </div>
                                               ...
                                               <div class="card social-card bg-twitter">
                                                   <div class="card-block">
                                                       <div class="row align-items-center">
                                                           <div class="col-auto">
                                                               <i
                                                                   class="feather icon-twitter f-34 text-twitter social-icon"></i>
                                                           </div>
                                                           <div class="col">
                                                                   ...
                                                                   <div class="chk-option">
                                                                       <div class="checkbox-fade fade-in-primary">
                                                                           <label class="check-task">
                                                                               ...
                                                                               <span class="cr">
                                                                                   <i
                                                                                       class="cr-icon feather icon-check f-w-600 txt-default"></i>
                                                                               </span>
                                                                           </label>
                                                                       </div>
                                                                   </div>
                                                           ...
                                                           <tr>
                                                               <td>
                                                                   ...
                                                                   <div class="d-inline-block align-middle">
                                                                       <img src="../../assets/admin/assets/assets/images/avatar-4.jpg"
                                                                           alt="user image"
                                                               ...
                                                               <td class="text-right"><label
                                                                       class="label label-danger">Low</label></td>
                                                           </tr>
                                                           <tr>
                                                               <td>
                                                                   <div class="chk-option">
                                                                   ...
                                                                   <div class="d-inline-block align-middle">
                                                                       <img src="../../assets/admin/assets/assets/images/avatar-2.jpg"
                                                                           alt="user image"
                                                                           class="img-radius img-40 align-top m-r-15">
                                                                       <div class="d-inline-block">
                                                               ...
                                                               <td>March, 31</td>
                                                               <td class="text-right"><label
                                                                       class="label label-primary">high</label></td>
                                                           </tr>
                                                           <tr>
                                                               <td>
                                                                   <div class="chk-option">
                                                                   ...
                                                                   <div class="d-inline-block align-middle">
                                                                       <img src="../../assets/admin/assets/assets/images/avatar-3.jpg"
                                                                           alt="user image"
                                                                           class="img-radius img-40 align-top m-r-15">
                                                                       <div class="d-inline-block">
                                                                           <h6>William Jem</h6>
                                               ...
                                               <div class="latest-update-box">
                                                   ...
                                                   <div class="row p-t-20 p-b-20">
                                                       ...
                                                       <div class="col">
                                                           ...
                                                           <p class="text-muted m-b-0">Download the <span> <a href="#!"
                                                                       target="_top" class="text-c-blue">latest
                                                                       backup</a> </span>.</p>
                                                       </div>
                                                   </div>
                                                   <div class="row p-t-20 p-b-20">
                                           ...
                                           <div class="card-block">
                                               <div class="review-block">
                                                   <div class="row">
                                                       ...
                                                       <div class="col">
                                                           <h6 class="m-b-15">John Deo <span
                                                                   class="float-right f-13 text-muted"> a week
                                                                   ago</span></h6>
                                                           <a href="#!"><i
                                                           ...
                                                           <a href="#!"><i
                                                                   class="feather icon-star-on f-18 text-c-yellow"></i></a>
                                                           <a href="#!"><i
                                                                   class="feather icon-star f-18 text-default"></i></a>
                                                           <a href="#!"><i
                                                                   class="feather icon-star f-18 text-default"></i></a>
                                                           <p class="m-t-15 m-b-15 text-muted">Lorem Ipsum is simply
                                                               dummy text of the printing and typesetting industry.
                                                               Lorem Ipsum has been the industry's standard dummy text
                                                               ever since the 1500s, when an unknown printer took a
                                                               galley of type and scrambled it to make a type specimen
                                                               book.</p>
                                                           <a href="#!" class="m-r-30"><i
                                                   ...
                                                   <div class="row">
                                                       ...
                                                       <div class="col">
                                                           <h6 class="m-b-15">Allina D’croze <span
                                                                   class="float-right f-13 text-muted"> a week
                                                                   ago</span></h6>
                                                           <a href="#!"><i
                                                                   class="feather icon-star-on f-18 text-c-yellow"></i></a>
                                                           ...
                                                           <blockquote class="blockquote m-t-15 m-b-0">
                                                               ...
                                                               <p class="m-b-0 text-muted">Lorem Ipsum is simply dummy
                                                                   text of the industry.</p>
                                                           </blockquote>
                                                       </div>
                                                   </div>
                                               </div>
                                               <div class="text-right  m-r-20">
                                                   <a href="#!" class="b-b-primary text-primary">View all Customer
                                                       Reviews</a>
                                               </div>
                                           </div>
                                       </div>
                                   ...
                                   <div class="col-lg-4 col-md-12">
                                           ...
                                           <div class="card-block">
                                               <div class="row m-b-20 received-chat">
                                                   ...
                                                   <div class="col">
                                                       ...
                                                       <p class="text-muted m-b-0"><i
                                                               class="feather icon-clock m-r-10"></i>10:20am</p>
                                                   </div>
                                               </div>
                                               ...
                                               <div class="row m-b-20 received-chat">
                                                   ...
                                                   <div class="col">
                                                       <div class="msg">
                                                           <p class="m-b-0">Nice to meet you!</p>
                                                           <img src="../../assets/admin/assets/assets/images/mega-menu/01.jpg"
                                                               alt="">
                                                           <img src="../../assets/admin/assets/assets/images/mega-menu/03.jpg"
                                                               alt="">
                                                       </div>
                                                       <p class="text-muted m-b-0"><i
                                                               class="feather icon-clock m-r-10"></i>10:20am</p>
                                       ...
                                       <div class="card user-card2">
                                           ...
                                           <button class="btn btn-success btn-block p-t-15 p-b-15">Download Overall
                                               Report</button>
                                       </div>
                                   </div>
                                   <!-- project and updates end -->
