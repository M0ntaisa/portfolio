                                        ...
                                        <div class="row">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <div class="d-inline-block align-middle">
                                                                                <img src="../../assets/admin/assets/assets/images/avatar-4.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <div class="d-inline-block align-middle">
                                                                                <img src="../../assets/admin/assets/assets/images/avatar-2.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
                                                                                <div class="d-inline-block">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <div class="d-inline-block align-middle">
                                                                                <img src="../../assets/admin/assets/assets/images/avatar-3.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
                                                                                <div class="d-inline-block">
                                                                                    <h6>William Jem</h6>
                                                        ...
                                                        <div class="review-block">
                                                            <div class="row">
                                                                <div class="col-sm-auto p-r-0">
                                                                    <img src="../../assets/admin/assets/assets/images/avatar-2.jpg" alt="user image" class="img-radius profile-img cust-img m-b-15">
                                                                </div>
                                                                <div class="col">
                                                                    ...
                                                                    <a href="#!"><i class="feather icon-star-on f-18 text-c-yellow"></i></a>
                                                                    <a href="#!"><i class="feather icon-star-on f-18 text-c-yellow"></i></a>
                                                                    <a href="#!"><i class="feather icon-star f-18 text-default"></i></a>
                                                                    <a href="#!"><i class="feather icon-star f-18 text-default"></i></a>
                                                                    ...
                                                                    <a href="#!" class="m-r-30"><i class="feather icon-thumbs-up m-r-15"></i>Helpful?</a>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-auto p-r-0">
                                                                    <img src="../../assets/admin/assets/assets/images/avatar-4.jpg" alt="user image" class="img-radius profile-img cust-img m-b-15">
                                                                </div>
                                                                <div class="col">
                                            ...
                                            <div class="col-lg-4 col-md-12">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row m-b-20 received-chat">
                                                            <div class="col-auto p-r-0">
                                                                <img src="../../assets/admin/assets/assets/images/avatar-2.jpg" alt="user image" class="img-radius img-40">
                                                            </div>
                                                            <div class="col">
                                                                <div class="msg">
                                                        ...
                                                        <div class="row m-b-20 send-chat">
                                                            ...
                                                            <div class="col-auto p-l-0">
                                                                <img src="../../assets/admin/assets/assets/images/avatar-3.jpg" alt="user image" class="img-radius img-40">
                                                            </div>
                                                        </div>
                                                        <div class="row m-b-20 received-chat">
                                                            <div class="col-auto p-r-0">
                                                            ...
                                                            <div class="col">
                                                                <div class="msg">
                                                                    <p class="m-b-0">Nice to meet you!</p>
                                                                    <img src="../../assets/admin/assets/assets/images/mega-menu/01.jpg" alt="">
                                                                    <img src="../../assets/admin/assets/assets/images/mega-menu/03.jpg" alt="">
                                                                </div>
                                                                <p class="text-muted m-b-0"><i class="feather icon-clock m-r-10"></i>10:20am</p>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="card user-card2">
                                                    ...
                                                    <button class="btn btn-success btn-block p-t-15 p-b-15">Download Overall Report</button>
                                                </div>
                                            </div>
                                            <!-- project and updates end -->
                                        </div>
